  ...
  return (
    <main className="container-app py-16">
      <div className="mx-auto max-w-md rounded-4xl bg-white/90 p-10 shadow-[0_25px_60px_-30px_rgba(15,23,42,0.3)] border border-slate-200/80 dark:bg-slate-950/90 dark:border-slate-800/70 dark:text-slate-100">
        <h1 className="text-4xl font-semibold mb-4 text-slate-900 dark:text-slate-100">Registrar</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div className="text-center text-sm text-slate-500">
            Já tem conta?{' '}
            <Link to="/login" className="font-semibold text-cyan-500 hover:text-teal-400">Entrar</Link>
          </div>
        </form>
      </div>
    </main>
